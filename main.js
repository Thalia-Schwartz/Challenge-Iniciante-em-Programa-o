...
function limpar() {
    ...
    document.getElementById('mensagem').innerHTML = "<div id='mensagem'><img src='pessoaLupa.svg' alt='Pessoa desenhada sentada, analizando um diamante com o auxílio de uma lupa'><h3>Nenhuma mensagem encontrada</h3><p>Digite o texto que você deseja criptografar ou descriptografar.</p></div>";
}
